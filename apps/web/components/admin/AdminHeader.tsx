...
import { ShieldCheck, LogOut, Sparkles, Bell } from 'lucide-react';
    ...
    <header className="h-16 border-b border-white/10 bg-slate-900/60 backdrop-blur-xl px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          title="Keluar Admin"
          className="p-2 rounded-xl bg-slate-800 border border-white/10 text-slate-400 hover:text-rose-400 transition-colors"
        >
